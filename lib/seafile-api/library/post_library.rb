module SeafileApi
  class Connect
    ...
    def post_default_lib
      c = curl_new("#{self.host}/api2/default-repo/")
      c.http_post()
      c.body_str
    end
    ...
    def post_public_lib(repo_id)
      c = curl_new("#{self.host}/api2/repos/#{repo_id}/public/")
      c.http_post()
      c.body_str
    end
    ...
    def post_lib(name,desc)
      c = curl_new("#{self.host}/api2/repos/")
    ...
    def post_lib_pass(repo_id,password)
      c = curl_new("#{self.host}/api2/repos/#{repo_id}/")
